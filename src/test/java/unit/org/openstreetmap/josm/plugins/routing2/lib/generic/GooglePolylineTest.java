...
class GooglePolylineTest {
    static Stream<Arguments> values() {
        return Stream.of(
                Arguments.of((Object) new double[] {38.5, -120.2}),
    ...
    @Test
    void testEncode() {
        assertEquals("_p~iF~ps|U_ulLnnqC_mqNvxq`@", GooglePolyline.encode(38.5, -120.2, 40.7, -120.95, 43.252, -126.453));
    }
